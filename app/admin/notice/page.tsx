  ...
  const fetchNotices = async () => {
    ...
    try {
      const response = await fetch(
        `/api/notices?searchCategory=${searchCategory}&searchTerm=${encodeURIComponent(searchTerm)}&startDate=${startDate}&endDate=${endDate}&page=${currentPage}&pageSize=${pageSize}`
      );
